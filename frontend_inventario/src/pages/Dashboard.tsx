    ...
    <div className="relative min-h-screen bg-[#f8fafc] overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          <Link to="/items" className="block transform transition-transform hover:scale-[1.02] active:scale-95">
            <StatCard
              title="Productos"
          ...
          <Link to="/categories" className="block transform transition-transform hover:scale-[1.02] active:scale-95">
            <StatCard
              title="Categorías"
          ...
          <Link to="/movements" className="block transform transition-transform hover:scale-[1.02] active:scale-95">
            <StatCard
              title="Movimientos"
          ...
          <Link to="/items?filter=low-stock" className="block transform transition-transform hover:scale-[1.02] active:scale-95">
            <StatCard
              title="Bajo Stock"
